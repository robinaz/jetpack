...
class WordAds_Params {
	...
	public function __construct() {
		$this->options = array(
			'wordads_tos'      => get_option( 'wordads_tos',      false ),
			'wordads_approved' => get_option( 'wordads_approved', false ),
			'wordads_active'   => get_option( 'wordads_active',   false ),
			'enable_header_ad' => get_option( 'enable_header_ad', false )
		);
